pytest -v -s  -m "sanity" --browser firefox --html=Reports\report_sanity.html  --capture=tee-sys .\testcases\
rem pytest -v -s  -m "sanity" --browser chrome --html=Reports\report_sanity.html  --capture=tee-sys .\testcases\
REM pytest -v -s  -m "regression" --browser firefox --html=Reports\report_sanity.html  --capture=tee-sys .\testcases\
